...
/**
 *Esta clase comprueba los métodos de la clase Libro y realiza sus test
...
public class LibroTest {
    ...
    public void testAddHoja() throws ExcelAPIException  {
        ...
        Hoja hoja = new Hoja ("dani", filas, columnas);
     ...
     */
    @Test
    public void testRemoveHoja() throws ExcelAPIException {
     ...
     * ya está comprobado en el testAddHoja
     */
    /*
    @Test
    ...
    public void testLoad_0args() throws ExcelAPIException {
        ...
        Libro instance = new Libro();
        instance.load("libroPrueba.xlsx");
     ...
     * También comprueba la extensión, si no la tiene o no es igual 
     * añade ".xlsx"
     */   
    @Test
    public void testSave_0args() throws ExcelAPIException {
        System.out.println("save");        
        Libro instance = new Libro("test");
        //Comprueba la extension, para añadir o cambiarla ".xlsx"
        instance.extension();
